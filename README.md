# ![icon](Assets/icon/Vivladi-GX-Stretched-32.png) Vivaldi GX Revisited (Modified/Updated for 6.2)
...
- Update from 6.1 to 6.2 by [@gomizilla](https://forum.vivaldi.net/user/gomizilla) with contributions from [@beyxnd](https://forum.vivaldi.net/user/beyxnd)
